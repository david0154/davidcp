		...
		<div class="container">
			<div class="output-card">
				...
				<CopyToClipboardInput
					class="u-mb10"
					value="wget https://raw.githubusercontent.com/davidcp/davidcp/release/install/dvp-install.sh"
				/>
				<p class="u-mb10">
...
const installCommand = ref("bash dvp-install.sh");
watchEffect(() => {
	let cmd = "bash dvp-install.sh";
