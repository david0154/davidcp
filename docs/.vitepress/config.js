...
export default defineConfig({
	...
	themeConfig: {
		...
		socialLinks: [
			{ icon: 'github', link: 'https://github.com/davidcp/davidcp' },
			{ icon: 'twitter', link: 'https://twitter.com/HestiaPanel' },
			{ icon: 'facebook', link: 'https://www.facebook.com/davidcp' },
		],
		...
		editLink: {
			pattern: 'https://github.com/davidcp/davidcp/edit/main/docs/:path',
			text: 'Edit this page on GitHub',
		},

		footer: {
			message: 'Released under the GPLv3 License.',
			copyright: 'Copyright © 2019-present David Control Panel',
		},
	...
	return [
		...
		{ text: 'Donate', link: '/donate' },
		{
			...
			items: [
				{
					text: 'Changelog',
					link: 'https://github.com/davidcp/davidcp/blob/main/CHANGELOG.md',
				},
				{
					text: 'Contributing',
					link: 'https://github.com/davidcp/davidcp/blob/main/CONTRIBUTING.md',
				},
				{
					text: 'Security policy',
					link: 'https://github.com/davidcp/davidcp/blob/main/SECURITY.md',
				},
			],
		},
	];
...
function sidebarDocs() {
	return [
		...
		},
		{
			...
			collapsed: false,
			items: [
				{ text: 'David Nginx Cache', link: '/docs/community/david-nginx-cache' },
				{
					text: 'Ioncube installer for David',
					link: '/docs/community/ioncube-david-installer',
				},
