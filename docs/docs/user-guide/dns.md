...
- **default-nomail**: Standard DNS template. Suitable for most usecases when you don’t want to host mail on David.
...
This date is not used by David, but can be used as a reminder.
