...
# David Control Panel upgrade script for target version 1.4.13
...
if [ "$PHPMYADMIN_KEY" != "" ]; then
	echo "[ * ] Updating david-sso for phpMyAdmin..."
