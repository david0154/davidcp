...
# David Control Panel upgrade script for target version 1.6.0
...
if [ "$MAIL_SYSTEM" = "exim4" ]; then
	...
	cp $DAVID_INSTALL_DIR/exim/limit.conf /etc/exim4/limit.conf
	cp $DAVID_INSTALL_DIR/exim/system.filter /etc/exim4/system.filter
...
cp -rf $DAVID_INSTALL_DIR/api $DAVID/data/
