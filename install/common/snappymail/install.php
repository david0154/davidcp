...
\SnappyMail\Repository::installPackage("plugin", "change-password-david");
		...
		json_encode(
			[
				"plugin" => [
					...
					"driver_david_enabled" => true,
					"driver_david_allowed_emails" => "*",
					"david_host" => gethostname(),
					"david_port" => $argv[4], // $BACKEND_PORT
				],
			],
			JSON_PRETTY_PRINT,
		),
...
$sFile = APP_PRIVATE_DATA . "domains/david.json";
if (!file_exists($sFile)) {
