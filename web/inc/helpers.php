 ...
 * @param string $user A username for save in the user history ou 'system' to save in David history.
 * @return int The script result code.
 */
function dvp_add_history_log($message, $category = "System", $level = "Info", $user = "system") {
