		...
		<?php require $_SERVER["DAVID"] . "/web/templates/includes/app-footer.php"; ?>
...
<?php } ?>
	...
	<?php require $_SERVER["DAVID"] . "/web/templates/includes/jump-to-top-link.php"; ?>

	<?php if ($_SESSION["DEBUG_MODE"] == "true") {
		require $_SERVER["DAVID"] . "/web/templates/pages/debug_panel.php";
	} ?>
