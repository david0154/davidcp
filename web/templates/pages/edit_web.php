		...
		<div class="form-container">
			...
			<div x-cloak x-show="sslEnabled" class="u-pl30">
				...
				<div class="form-check u-mb20">
					<input class="form-check-input" type="checkbox" name="v_ssl_dvps" id="ssl_dvps" <?php if ($v_ssl_dvps == 'yes') echo 'checked' ?>>
					<label for="ssl_dvps">
						<?= _("Enable HTTP Strict Transport Security (DVPS)") ?>
					...
					<?php if ($_SESSION["WEB_SYSTEM"] == "nginx") { ?>
						<div class="form-check u-mb10">
							...
							<label for="v_nginx_cache_check">
								...
								<a href="https://davidk.online/docs/server-administration/web-templates.html#nginx-fastcgi-cache" target="_blank" class="u-ml5">
