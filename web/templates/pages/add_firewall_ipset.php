...
<div class="container">
	...
	<form id="main-form" name="v_add_ipset" method="post">
		...
		$blacklist_iplists = [
			["name" => "[IPv4] " . _("Block Malicious IPs"), "source" => "script:/usr/local/david/install/common/firewall/ipset/blacklist.sh"],
			// Uncomment below for IPv6
			// array('name' => "[IPv6] " . _("Block Malicious IPs"), 'source' => "script:/usr/local/david/install/common/firewall/ipset/blacklist.ipv6.sh"),
		];
		?>
