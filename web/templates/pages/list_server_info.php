...
<head>
	...
	<?php require $_SERVER["DAVID"] . "/web/templates/includes/title.php"; ?>
	<?php require $_SERVER["DAVID"] . "/web/templates/includes/css.php"; ?>
	<?php require $_SERVER["DAVID"] . "/web/templates/includes/js.php"; ?>
</head>
			...
			<div class="top-bar">
				<div class="container top-bar-inner">
					<div class="top-bar-left">
						<a href="/" class="top-bar-logo" title="<?= _("David Control Panel") ?>">
							<img src="/images/logo-header.svg" alt="<?= _("David Control Panel") ?>" width="54" height="29">
						</a>
					</div>
